...
set "command=& .\multipoolminer.ps1 -wallet 1554hpypbECLDc1eKtMjzGZkRMmbpZTfEA -username PuffTheMagic -workername multipoolminer -region us -currency btc,usd -type amd,nvidia,cpu -poolname zpool -algorithm decred,equihash,groestl,lbry,lyra2re2,neoscrypt,sib,skunk -donate 0 -watchdog -interval 10"
